...
class AwardQualifications extends Component {
    ...
    render() {
      ...
      console.log(_this.contract.currentUserAddress)
        ...
        <div className='awardQualifications'>
            <Container>
                ...
                <CreateQualificationForm 
                    contract={_this.contract.QualificationOwnershipInstance} 
                ...
                getQualifications={_this.getQualificationsByTrgEstablishment}
                />
            </Container>
        </div>
)
